class GitMiniCommitBinary < Formula
  ...
  url "https://github.com/mimimi105/git-mini-commit/releases/download/v0.1.0/git-mini-commit-darwin-amd64"
  sha256 "PLACEHOLDER_SHA256_DARWIN_AMD64"
  license "MIT"

  if Hardware::CPU.arm?
    url "https://github.com/mimimi105/git-mini-commit/releases/download/v0.1.0/git-mini-commit-darwin-arm64"
